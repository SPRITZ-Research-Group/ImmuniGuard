...
public class URLShortenerMediumTest {
    ...
    public void alreadyGooGlUrl() throws IOException {
        URL resultUrl = new net.alea.beaconsimulator.util.URLShortener(mServiceUrl).minifyUrl(URL_BITLY);
    ...
    public void httpErrorResponseCode() throws IOException {
        enqueueServerError();
        new net.alea.beaconsimulator.util.URLShortener(mServiceUrl).minifyUrl(URL_GOOD);
    }
