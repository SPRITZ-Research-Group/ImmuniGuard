...
public class URLShortenerShortTest {
    ...
    private static class UrlShortenerTestSpecific extends net.alea.beaconsimulator.util.URLShortener {
    ...
    public void alreadyBitlyUrl() throws IOException {
        // Fixture
        net.alea.beaconsimulator.util.URLShortener urlShortener = spy(new UrlShortenerTestSpecific(DUMMY_KEY));
